...
//  var levelNumber = p.options.level;
  var levelNumber;
    if(p.options.data.tow){
      if(p.options.data.tow==1)levelNumber = p.options.level+"▼";
      if(p.options.data.tow==2)levelNumber = p.options.level+"●";
    }else{levelNumber = p.options.level;}
